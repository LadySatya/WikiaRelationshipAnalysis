...
class TestWikiaCrawlerInit:
    ...
    def test_init_with_invalid_project_name_chars(self, basic_config):
        ...
        for invalid_name in invalid_names:
            with pytest.raises(ValueError, match="Project name contains invalid characters"):
    ...
    def test_init_creates_project_directory_structure(self, basic_config, temp_project_dir):
    ...
    def test_init_creates_component_instances(self, mock_rate_limiter, mock_session_manager, 
                                             mock_url_manager, basic_config):
